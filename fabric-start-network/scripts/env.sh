...
function initPeerVars {
   ...
   export CORE_VM_ENDPOINT=http://172.17.0.1:2375
#   export CORE_VM_ENDPOINT=unix:///host/var/run/docker.sock
   ...
   if [ $NUM -gt 1 ]; then
      ...
      export CORE_PEER_GOSSIP_BOOTSTRAP=node1.$ORG:7051
   fi
}
